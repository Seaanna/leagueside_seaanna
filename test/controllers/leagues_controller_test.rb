...
class LeaguesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create league" do
    assert_difference('League.count') do
      post leagues_url, params: { league: { latitude: @league.latitude, longitude: @league.longitude, name: @league.name, price: @league.price } }
    end
  ...
  test "should update league" do
    patch league_url(@league), params: { league: { latitude: @league.latitude, longitude: @league.longitude, name: @league.name, price: @league.price } }
